...
func Run() error {
	...
	)
	{
		...
		auth.GET("dockerProxies", controller.GetDockerProxies)
		auth.POST("dockerProxy", controller.PostDockerProxy)
		auth.DELETE("dockerProxy", controller.DeleteDockerProxy)
	}
